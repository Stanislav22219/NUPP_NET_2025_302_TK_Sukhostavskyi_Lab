...
namespace VideoGames.Infrastructure.Migrations
{
    ...
    [Migration("20250529202602_InitialIdentitySetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoGames.Infrastructure.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VideoGames.Infrastructure.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VideoGames.Infrastructure.Models.GameModel", b =>
                {
                    b.HasOne("VideoGames.Infrastructure.Models.DeveloperModel", "Developer")
                        .WithMany("Games")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
